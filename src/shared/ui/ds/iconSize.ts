...
//
// 컨텍스트 기준 (CLAUDE 규약, 2026-05-12 학원장 가시성 보강):
//   xs (14) : matrix cell / dense list / 1ch badge 안
//   sm (16) : 인라인 라벨 / button-sm / badge-md (가장 흔한 기본값)
//   md (18) : button-md / table action / 일반 헤더
//   lg (22) : kpi / card 메타 강조
//   xl (28) : 대표 액션 / 로고 옆 강조
//
// 사용:
