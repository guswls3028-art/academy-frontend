// PATH: src/shared/product/fees/feesStatus.ts
// 수납 상태 라벨·tone SSOT. PC 어드민·모바일 선생앱 공용.

import type { InvoiceStatus } from "@/shared/api/contracts/fees";

export type { InvoiceStatus } from "@/shared/api/contracts/fees";
