...
export const PRICE_POLICY_NOTES = [
  "월 구독 요금이며 부가세 별도입니다.",
  "Standard와 Pro는 핵심 기능 범위가 동일하고, 학부모 리포트 운영 범위·담당 수강생 수·사용 계정·저장공간·지원 우선순위에서 차이가 납니다.",
  "학부모 신뢰 리포트, 알림톡, 공개 홍보 페이지는 수강생 수와 발송량 기준으로 실제 운영 비용이 달라집니다.",
...
export const PROMO_PLANS: PromoPlanDef[] = [
  ...
  },
  {
    ...
    positioning: "신뢰 리포트를 운영 루틴으로 만드는 플랜",
    verdict: "채점·피드백·영상·학부모 설명까지 실제 수업 기준",
  ...
  },
  {
    ...
    positioning: "학교별 리포트와 홍보까지 확장",
    verdict: "한도보다 신뢰 리포트 설계와 지원이 중요한 팀",
    studentLimit: "무제한",
    adminLimit: "무제한",
    storage: "200GB",
    support: "전담 온보딩",
...
export const PRICE_COMPARISON = [
  ...
  { feature: "학부모 신뢰 리포트", standard: "기본", pro: "주간 운영", max: "학교별 템플릿 포함" },
  { feature: "적중 리포트 공개 홍보", standard: "기본", pro: "랜딩 게시 포함", max: "상담/공유 패키지 포함" },
