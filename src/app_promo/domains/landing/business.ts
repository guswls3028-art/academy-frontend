...
export const PRICE_POLICY_NOTES = [
  "월 구독 요금이며 부가세 별도입니다.",
  "Standard와 Pro는 기본 기능 범위가 같고, 담당 수강생 수·계정 수·저장공간·지원 우선순위에서 차이가 납니다.",
  "학부모 리포트, 알림톡, 공개 소개 페이지는 수강생 수와 발송량에 따라 실제 운영 비용이 달라집니다.",
...
export const PROMO_PLANS: PromoPlanDef[] = [
  {
    ...
    verdict: "출결·시험·영상·알림 기본 흐름부터 시작",
  ...
  },
  {
    ...
    verdict: "채점·피드백·영상·학부모 안내까지 한 흐름",
