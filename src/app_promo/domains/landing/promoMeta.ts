...
export const PROMO_META: Record<string, PromoMeta> = {
  ...
  "/promo/features": {
    ...
    description:
      "적중 매치업·칠판용 PPT, 시험·성적, 학생앱 영상, 알림톡, 보강 관리의 실제 제품 화면을 확인하세요.",
  },
  "/promo/matchup-ppt": {
  ...
  "/promo/ai-grading": {
    ...
    description:
      "객관식·OX형·정답이 분명한 단답형은 자동으로 채점하고, 서술형은 선생님이 직접 확인하는 성적 관리 흐름을 소개합니다.",
  },
  ...
  "/promo/pricing": {
    ...
    description:
      "전체 기능을 포함한 기본 월 요금과 2026년 8월 가입 적용 요금, 별도 비용 기준을 안내합니다.",
  },
  "/promo/faq": {
