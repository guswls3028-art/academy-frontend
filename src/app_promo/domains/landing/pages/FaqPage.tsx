...
const FAQS = [
  ...
  },
  {
    ...
    a: "가능한 흐름으로 설계되어 있습니다. 저장된 성적, 피드백, 수업 결과를 기준으로 안내 템플릿을 구성하고, 선생님이 검수한 내용만 발송하는 방식으로 운영하는 것을 권장합니다.",
  },
  {
    q: "AI 자동채점은 어떤 유형의 문제를 지원하나요?",
    a: "객관식, OX형, 단답형처럼 정답 기준이 분명한 문항은 자동 판정을 지원합니다. 서술형은 AI가 초안 점수와 근거를 제안하고, 선생님이 최종 검수하는 구조입니다.",
  },
  {
    q: "서술형도 완전 자동으로 채점되나요?",
    a: "아닙니다. 성적은 민감하기 때문에 서술형은 완전 자동 확정보다 ‘AI 보조 평가 + 선생님 검수’를 기본 구조로 설명하는 것이 맞습니다. 최종 점수 확정 권한은 선생님에게 있습니다.",
  },
  {
    q: "가격은 어떻게 구분되나요?",
        ...
        <div className={styles.sectionWrap}>
          <div className={styles.faqShell}>
            <aside className={styles.faqRail}>
              ...
              <p>선생님이 읽는 페이지라서 과장보다 확인 가능한 기준을 앞에 두었습니다.</p>
        ...
        <div className={styles.sectionWrap}>
          <article className={`${styles.proofCard} ${styles.proofCardFeatured}`} data-tone="video">
            ...
            <div className={styles.proofText}>
              ...
              <p>
                설명보다 화면이 먼저 와야 합니다. 학생이 실제로 보는 앱 화면을
