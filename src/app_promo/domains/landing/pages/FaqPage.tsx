...
const FAQS = [
  ...
  },
  {
    ...
    a: "단일 요금제입니다. 월 공급가 145,000원, 부가가치세 14,000원, 총 결제액 159,000원이며 모든 기능을 포함합니다. 알림톡 발송비와 저장공간 초과, 대량 이전, 커스텀 개발은 별도 협의입니다.",
  },
  {
...
const QUICK_CHECKS = [
  ...
  { icon: ReceiptText, text: "공급가 145,000원 · 부가가치세 14,000원 · 총 159,000원" },
