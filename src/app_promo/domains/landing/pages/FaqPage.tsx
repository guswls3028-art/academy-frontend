...
const FAQS = [
  ...
  },
  {
    ...
    a: "2026년 8월 가입 특별가는 월 공급가 145,000원, 부가가치세 14,000원, 총 결제액 159,000원입니다. 모든 기능을 포함하며, 8월에 가입한 학원은 이후 신규 가입 가격이 인상되어도 이 가격을 계속 보장받습니다. 알림톡 발송비와 저장공간 초과, 대량 이전, 커스텀 개발은 별도 협의입니다.",
  },
  {
...
const QUICK_CHECKS = [
  ...
  { icon: ReceiptText, text: "8월 가입 특별가 총 159,000원 · 평생 가격 보장" },
