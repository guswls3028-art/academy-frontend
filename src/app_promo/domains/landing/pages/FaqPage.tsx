...
const FAQS = [
  ...
  },
  {
    ...
    a: "2026년 8월 1일부터 31일까지 가입한 학원은 월 14만 5천원(부가세 별도)이며, 해당 요금이 서비스를 이용하는 동안 유지됩니다. 8월 이후 가입 요금은 월 16만원(부가세 별도)입니다. 기본 저장공간은 200GB이며 알림톡 발송비, 저장공간 초과, 대량 이전, 맞춤 개발은 별도 협의합니다.",
  },
  {
...
const QUICK_CHECKS = [
  ...
  { icon: ReceiptText, text: "8월 가입 월 14만 5천원 · 이후 가입 월 16만원 · 부가세 별도" },
