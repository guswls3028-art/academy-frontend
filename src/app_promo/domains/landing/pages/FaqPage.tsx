...
const FAQS = [
  ...
  },
  {
    ...
    a: "평소 요금은 부가가치세 포함 월 198,000원입니다. 2026년 8월 1일부터 31일까지 가입한 학원은 공급가 월 145,000원(부가세 별도), 실제 월 결제 159,000원이 서비스를 이용하는 동안 계속 적용됩니다. 기본 저장공간은 200GB이며 알림톡 발송비, 저장공간 초과, 대량 이전, 맞춤 개발은 별도 협의합니다.",
  },
  {
...
const QUICK_CHECKS = [
  ...
  { icon: ReceiptText, text: "8월 가입 공급가 월 145,000원 · 부가세 포함 결제 159,000원" },
