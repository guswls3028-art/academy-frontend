// PATH: src/features/fees/components/FeesDashboardTab.tsx
...
import { fetchDashboard, fetchOverdueInvoices, type DashboardStats, type StudentInvoice } from "../api/fees";
