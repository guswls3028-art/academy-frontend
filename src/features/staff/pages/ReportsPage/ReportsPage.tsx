...
export default function ReportsPage() {
  ...
  return (
    <div className="flex flex-col gap-4">
      {/* 기준 월 헤더 — Design SSOT: SectionHeader + ds-input */}
      <div
        className="ds-panel-card px-6 py-4"
        style={{ boxShadow: "var(--elevation-1)" }}
      >
        <div className="flex items-start justify-between gap-4">
          <div className="space-y-1">
            <div className="text-lg font-semibold text-[var(--color-text-primary)]">리포트</div>
            <div className="text-sm text-[var(--color-text-muted)]">
              기준월 <b>{ymLabel(ym.year, ym.month)}</b> · 모든 수치는 <b>서버 확정 데이터</b> 기준입니다.
            </div>
          </div>
