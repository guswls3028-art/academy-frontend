...
import { useAgentStream } from "@/dev_app/hooks/useAgentStream";
import { STATUS_META } from "@/dev_app/types/agent";
import type { AgentState, AgentStatus } from "@/dev_app/types/agent";
import { AgentDeskCard } from "@/dev_app/components/agent/AgentDeskCard";
import { AgentDetailPanel } from "@/dev_app/components/agent/AgentDetailPanel";
import { PixelDesk } from "@/dev_app/components/agent/PixelCharacter";
import { ZONES, INCIDENT_ZONE, getZoneForAgent } from "@/dev_app/components/agent/zoneConfig";
import type { ZoneConfig } from "@/dev_app/components/agent/zoneConfig";
