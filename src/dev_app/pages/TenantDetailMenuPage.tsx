// PATH: src/dev_app/pages/TenantDetailMenuPage.tsx
// Tenant 상세 — 메뉴 카드 + 상단에서 바로 Owner 입력 (탭 없이, 작업 느낌)

import { useState, useEffect, useCallback } from "react";
import { Link, useParams, useNavigate } from "react-router-dom";
import { getTenants, getTenantOwners, removeTenantOwner, updateTenantOwner, type TenantDto, type TenantOwnerDto } from "@/dev_app/api/tenants";
