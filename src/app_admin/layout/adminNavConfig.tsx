...
export const ADMIN_NAV_GROUPS: AdminNavGroup[] = [
  {
    title: "메인",
    items: [
      { to: `${ADMIN_NAV_BASE}/dashboard`, label: "대시보드", iconPath: "M3 11l9-7 9 7v9H3z", keywords: ["홈", "오늘 업무", "처리할 일"] },
      { to: `${ADMIN_NAV_BASE}/guide`, label: "가이드", iconPath: "M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8zM14 2v6h6M16 13H8M16 17H8M10 9H8", keywords: ["도움말", "사용법", "매뉴얼"] },
      { to: `${ADMIN_NAV_BASE}/students`, label: "학생", iconPath: "M12 12a4 4 0 1 0-4-4 4 4 0 0 0 4 4Zm-7 8a7 7 0 0 1 14 0", keywords: ["원생", "학생 등록", "명단", "학부모"] },
      { to: `${ADMIN_NAV_BASE}/lectures`, label: "강의", iconPath: "M4 4h16v12H4zM8 20h8", keywords: ["수업", "차시", "보강", "출결"] },
      { to: `${ADMIN_NAV_BASE}/clinic`, label: "클리닉", iconPath: "M12 21s7-4 7-10a7 7 0 0 0-14 0c0 6 7 10 7 10Z", keywords: ["예약", "등원", "보충"] },
    ],
  },
  {
    title: "학습·운영",
    items: [
      { to: `${ADMIN_NAV_BASE}/exams`, label: "시험", iconPath: "M7 3h10v18H7zM9 7h6M9 11h6M9 15h4", keywords: ["시험지", "응시", "채점", "OMR"] },
      { to: `${ADMIN_NAV_BASE}/results`, label: "성적", iconPath: "M4 18h16M6 15V9M12 15V5M18 15v-7", keywords: ["점수", "성적표", "오답", "결과"] },
      { to: `${ADMIN_NAV_BASE}/videos`, label: "영상", iconPath: "M3 6h14v12H3zM17 10l4-2v8l-4-2z" },
      { to: `${ADMIN_NAV_BASE}/message`, label: "메시지", iconPath: "M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z", keywords: ["알림톡", "문자", "발송", "공지"] },
      { to: `${ADMIN_NAV_BASE}/storage`, label: "자료 저장소", iconPath: "M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z", keywords: ["파일", "문서", "시험지", "매치업"] },
    ],
  },
  {
    title: "관리",
    items: [
      { to: `${ADMIN_NAV_BASE}/fees`, label: "수납", iconPath: "M12 1v22M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6", keywords: ["결제", "청구", "미납", "영수증"], requiresTenantAdmin: true },
      { to: `${ADMIN_NAV_BASE}/community`, label: "커뮤니티", iconPath: "M4 4h16v12H7l-3 3z", keywords: ["질문", "Q&A", "공지", "상담"] },
      { to: `${ADMIN_NAV_BASE}/tools`, label: "도구", iconPath: "M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z", keywords: ["AI", "문제 스튜디오", "풀이", "리포트"] },
      { to: `${ADMIN_NAV_BASE}/staff`, label: "직원 관리", iconPath: "M12 12a4 4 0 1 0-4-4 4 4 0 0 0 4 4Zm-7 8a7 7 0 0 1 14 0", keywords: ["강사", "조교", "급여", "계정"], requiresStaffAdmin: true },
