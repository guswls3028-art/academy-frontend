...
export const ADMIN_NAV_GROUPS: AdminNavGroup[] = [
  ...
  },
  {
    title: "관리",
    items: [
      { to: `${ADMIN_NAV_BASE}/fees`, label: "수납", iconPath: "M12 1v22M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6", requiresFeatureFlag: "fee_management", requiresTenantAdmin: true },
