...
export type { AcademyEntry, TenantInfo, UpdateTenantInfoPayload } from "@/shared/api/contracts/tenantInfo";
export { fetchTenantInfo, updateTenantInfo } from "@/shared/api/contracts/tenantInfo";
