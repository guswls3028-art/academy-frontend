...
기존 qa-* 실패 항목을 재사용하여 관리자 계정의 전체 미통과 작업대 및 운영 콘솔
수동 통과를 확인한다. 운영 콘솔은 390px에서 통과한 뒤 PC에서 새로고침하고,
학생 성적 API의 반영과 API 되돌리기·항목 복원을 확인한 후 기존 예약·취소 검증을
계속한다. 통과와 되돌리기 모두 원래 시험 점수 20점을 보존해야 한다.
