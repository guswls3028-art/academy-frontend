// PATH: src/app_admin/domains/sessions/components/SessionScoresTab.tsx
/**
 * SessionScoresTab
 *
 * 책임:
...
import { downloadClinicPdf, getClinicStats } from "@admin/domains/scores/utils/clinicPdfGenerator";
import { generateScoreReport, buildScoreDetail, substituteScoreVars } from "@admin/domains/scores/utils/generateScoreReport";
...
import type { SessionScoresResponse } from "@admin/domains/scores/api/sessionScores";
