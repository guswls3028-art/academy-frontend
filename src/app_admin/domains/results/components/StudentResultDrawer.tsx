...
import {
  ...
  choiceTokens,
  formatChoiceAnswer,
  describeCorrectChoiceForDisplay,
  isChoiceAnswer,
              ...
              {choiceItems.map((it) => {
                ...
                return (
                  <div key={it.question_id} className={`srd-read__choice-cell ${it.answer ? (correct ? "srd-read__choice-cell--correct" : "srd-read__choice-cell--wrong") : "srd-read__choice-cell--empty"}`}>
                    ...
                    {showCorrectAnswer && <span className="srd-read__choice-correct" title={describeCorrectChoiceForDisplay(ca)}>{describeCorrectChoiceForDisplay(ca)}</span>}
                  </div>
                );
              })}
            </div>
