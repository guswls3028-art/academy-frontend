...
export const ADMIN_WORKFLOWS: GuideWorkflow[] = [
  ...
  },
  {
    ...
    title: "알림톡 보내기",
    summary:
      "성적·출결·클리닉 등 운영 알림톡을 발송하는 방법입니다.",
    steps: [
      { title: "알림톡으로 이동", description: "사이드바에서 '알림톡'을 클릭합니다." },
      { title: "업무 화면 선택", description: "성적 입력, 출결, 클리닉 등 알림톡을 보낼 업무 화면으로 이동합니다." },
      { title: "알림톡 확인", description: "자동 적용된 승인 양식과 수신 대상을 확인합니다." },
      { title: "발송", description: "'발송' 버튼을 눌러 전송합니다. 결과는 '발송 내역'에서 확인할 수 있어요." },
    ],
