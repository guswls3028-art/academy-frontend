...
const START_ITEMS: StartItem[] = [
  ...
  {
    label: "3",
    title: "학생 1명과 엑셀 등록으로 시범 운영",
    description: "전체 학생을 넣기 전에 테스트 학생을 직접 등록하고, 엑셀 일괄등록도 소량으로 한 번 확인합니다.",
  ...
  },
  {
    ...
    path: "/workspace/message/settings",
    action: "메시지 설정",
  },
];
...
const FIRST_USE_FINDINGS: FindingItem[] = [
  ...
  {
    title: "엑셀 일괄등록은 백그라운드 처리라 바로 안 보일 수 있음",
    risk: "파일 업로드 직후 학생 목록이 그대로이면 실패처럼 느껴질 수 있습니다.",
    resolution: "우상단 작업박스에서 '학생 일괄 등록' 완료를 확인한 뒤 목록을 봅니다. 대량 파일이나 워커 기동 상황에 따라 몇 분 걸릴 수 있습니다.",
  },
  {
