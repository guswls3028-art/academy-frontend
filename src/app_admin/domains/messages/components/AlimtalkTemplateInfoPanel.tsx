...
const TEMPLATE_TYPE_DESCRIPTIONS: Record<string, string> = {
  clinic_info: "학원이름, 학생이름, 장소, 날짜, 시간은 봉투에 자동 표시됩니다. 작성한 안내 문구는 #{선생님메모}에 들어갑니다.",
  clinic_change: "학원이름, 학생이름, 기존일정, 변동사항, 수정자는 봉투에 자동 표시됩니다. 작성한 안내 문구는 #{선생님메모}에 들어갑니다.",
  score: "학원이름, 학생이름, 강의명, 차시명은 봉투에 자동 표시됩니다. 작성한 성적 안내 문구는 #{선생님메모}에 들어갑니다.",
  attendance: "학원이름, 학생이름, 강의명, 차시명, 날짜, 시간은 봉투에 자동 표시됩니다. 작성한 안내 문구는 #{선생님메모}에 들어갑니다.",
      ...
      <div style={{
        ...
        {bodyEditable ? (
          <>
            ...
            본문에 안내 문구를 작성하면 카카오 알림톡의 <strong>#{`{선생님메모}`}</strong> 영역에 표시됩니다.
          </>
        ) : (
          <>
