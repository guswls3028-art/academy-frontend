    ...
    <div className={styles.root}>
      ...
      <div className={styles.container}>
        ...
        <article className={styles.article}>
          ...
          <h2>제2조 (정의)</h2>
          <ol>
            <li>&quot;서비스&quot;란 회사가 인터넷을 통해 제공하는 학원 관리 서비스로, 학생 관리, 출결, 성적, 시험, 수업 영상,
            ...
            <li>&quot;학원별 이용 공간&quot;이란 서비스에서 각 학원의 자료와 설정이 다른 학원과 분리되어 관리되는 공간을 말합니다.</li>
          ...
          <ol>
            ...
            <li>별도 계약이나 가입 행사에서 이용 기간 동안의 요금 유지가 명시된 경우에는 해당 조건이 우선합니다.</li>
          ...
          <ol>
            ...
            <li>회사는 각 학원의 데이터를 분리하여, 다른 학원의 데이터에 접근할 수
              없도록 합니다.</li>
          </ol>
          ...
          <ol>
            ...
            <li>계약 해지 시, 해당 학원 공간에 저장된 데이터는 관련 법령 및 개인정보 처리방침에 따라 일정 기간
              보유 후 파기합니다.</li>
          ...
          <h2>제17조 (시행일)</h2>
          <p>본 약관은 2026년 7월 26일부터 시행합니다.</p>
