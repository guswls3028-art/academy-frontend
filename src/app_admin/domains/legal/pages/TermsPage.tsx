// PATH: src/app_admin/domains/legal/pages/TermsPage.tsx
          ...
          <ol>
            ...
            <li>다음 각 호의 사유로 서비스 제공이 일시 중단될 수 있습니다:
              <ol>
                ...
                <li>외부 서비스(클라우드 인프라, 알림톡 발송 등) 장애</li>
              </ol>
            </li>
          ...
          <ol>
            ...
            <li>회사는 다음 각 호의 사유로 인한 손해에 대하여 책임을 지지 않습니다:
              <ol>
                ...
                <li>외부 서비스(클라우드 인프라, 통신사, 알림톡 발송 서비스 등)의 장애로 인한 손해</li>
