// PATH: src/app_admin/domains/legal/pages/PrivacyPage.tsx
    ...
    <div className={styles.root}>
      ...
      <div className={styles.container}>
        ...
        <article className={styles.article}>
          ...
          <ol>
            <li><strong>서비스 제공 및 운영:</strong> 학생 관리, 출결·성적·시험 관리, 수업 영상 제공, 과제 관리, 알림톡 발송</li>
            <li><strong>회원 관리:</strong> 본인 확인, 서비스 이용 계약 이행, 계정 관리</li>
            <li><strong>커뮤니케이션:</strong> 공지사항 전달, 서비스 관련 안내, 학부모 연락 (카카오 알림톡)</li>
          ...
          <table>
            ...
            <tbody>
              ...
              <tr>
                <td>데모·사용 상담</td>
                <td>이름, 연락처, 데모 요청 시 소속·수업명, 사용 상담 시 문의 유형·문의 내용(필수) / 이메일, 담당 수강생 수, 현재 관리 방식, 관심 기능, 요청 사항, 소속·수업명(사용 상담), 유입 경로(선택)</td>
              </tr>
            </tbody>
          </table>
          ...
          <ul>
            ...
            <li>학원플러스 홍보 페이지의 데모·사용 상담 양식을 통해 직접 입력</li>
          </ul>
          ...
          <ol>
            ...
            <li>보유 기간:
              <ul>
                ...
                <li><strong>데모·사용 상담:</strong> 상담 종료 또는 동의 철회 시까지 보유하며, 관계 법령상 보관 의무가 있는 경우 해당 기간 동안 별도 보관</li>
              </ul>
            </li>
          ...
          <ul>
            ...
            {c.support_phone && <li>전화: <V value={c.support_phone} /></li>}
          </ul>
          <p>
