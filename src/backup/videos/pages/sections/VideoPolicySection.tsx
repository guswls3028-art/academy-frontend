// src/features/videos/pages/sections/VideoPolicySection.tsx
...
export default function VideoPolicySection({ videoId, initial }: Props) {
  ...
  return (
    <div className="space-y-3 rounded border border-[var(--border-divider)] bg-[var(--bg-surface)] p-4">
      <div className="text-sm font-semibold text-[var(--text-primary)]">
        학생 시청 정책{" "}
        <span className="text-[var(--text-muted)]">(저장 후 반영)</span>
      </div>
