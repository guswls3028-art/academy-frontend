...
| 학생별 회차 누적 성적 | `e2e/admin/student-score-trend.spec.ts` | 관리자 성적 콘솔의 학원시험·학교내신·모의고사 출처 전환, 정규수업·보강수업 상단 범위 탭과 건수, 범위에 따른 요약·명단·추이·시험 기록 동시 변경, 기간·학생·강의·학년·득점·변화 필터, 학생 선택, 성적표 원본 검수·반영, 관리자·선생 학생 상세의 만점 정규화·자동 회차, 관리자 1366/1100px와 학생 상세·선생 모바일 390px 렌더 확인 | local route-mock 계약 검증. 혼합/미연결 시험의 실패 폐쇄 분류는 백엔드 테스트가 검증 |
