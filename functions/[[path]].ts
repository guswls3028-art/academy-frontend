...
const FALLBACK_META: Record<string, TenantMeta> = {
  ...
  "godmin.kr":          { title: "신민T 통합과학 | 신과함께", description: "13년 이상 통합과학을 가르쳐 온 신민T의 수업 철학과 학습 관리, 수강생·학부모 전용 학습 플랫폼.", favicon: "/tenants/godmin/favicon.png", image: "/tenants/godmin/og-image.png", imageWidth: 1200, imageHeight: 630 },
  "www.godmin.kr":      { title: "신민T 통합과학 | 신과함께", description: "13년 이상 통합과학을 가르쳐 온 신민T의 수업 철학과 학습 관리, 수강생·학부모 전용 학습 플랫폼.", favicon: "/tenants/godmin/favicon.png", image: "/tenants/godmin/og-image.png", imageWidth: 1200, imageHeight: 630 },
};
