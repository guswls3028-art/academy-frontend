...
export const routeMockSpecs = [
  ...
  "e2e/auth/subscription-notice.mock.spec.ts",
  "e2e/auth/iphone-safari-login.mock.spec.ts",
  "e2e/auth/safari-browser-support.mock.spec.ts",
  ...
  "e2e/admin/clinic-message-history.mock.spec.ts",
  ...
  "e2e/admin/auto-send-save-recovery.mock.spec.ts",
  ...
  "e2e/student/direct-video-access.mock.spec.ts",
  "e2e/student/video-cdn-service-error.mock.spec.ts",
  "e2e/student/video-review-transition.mock.spec.ts",
...
export const controlledWriteSpecs = [
  ...
  "e2e/student/student-parent-account-realuse.spec.ts",
  "e2e/student/student-parent-assessment-realuse.spec.ts",
  "e2e/student/student-parent-clinic-realuse.spec.ts",
  "e2e/student/student-parent-community-realuse.spec.ts",
