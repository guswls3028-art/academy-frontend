...
const ADMIN_ROUTES: AuditRoute[] = [
  { path: "/workspace/dashboard", label: "관리자 대시보드" },
  { path: "/workspace/students/home", label: "학생 홈" },
  { path: "/workspace/students/requests", label: "학생 가입 신청" },
  { path: "/workspace/students/deleted", label: "학생 퇴원/삭제" },
  { path: "/workspace/lectures", label: "강의 운영" },
  { path: "/workspace/lectures/past", label: "지난 강의" },
  { path: "/workspace/materials/sheets", label: "자료 시트" },
  { path: "/workspace/materials/reports", label: "자료 리포트" },
  { path: "/workspace/materials/messages", label: "자료 메시지" },
  { path: "/workspace/storage/matchup", label: "자료 저장소 매치업" },
  { path: "/workspace/storage/files", label: "자료 저장소 파일" },
  { path: "/workspace/storage/students", label: "학생 인벤토리" },
  { path: "/workspace/storage/hit-reports", label: "적중 보고서" },
  { path: "/workspace/storage/proposals", label: "자동 분리 검수" },
  { path: "/workspace/fees", label: "수납 대시보드" },
  { path: "/workspace/fees/invoices", label: "수납 청구" },
  { path: "/workspace/fees/templates", label: "수납 템플릿" },
  { path: "/workspace/clinic/home", label: "클리닉 홈" },
  { path: "/workspace/clinic/operations", label: "클리닉 운영" },
  { path: "/workspace/clinic/bookings", label: "클리닉 예약" },
  { path: "/workspace/clinic/reports", label: "클리닉 리포트" },
  { path: "/workspace/clinic/settings", label: "클리닉 설정" },
  { path: "/workspace/clinic/msg-settings", label: "클리닉 메시지 설정" },
  { path: "/workspace/exams", label: "시험" },
  { path: "/workspace/exams/templates", label: "시험 템플릿" },
  { path: "/workspace/exams/bundles", label: "시험 묶음" },
  { path: "/workspace/results", label: "성적 탐색" },
  { path: "/workspace/results/tree", label: "성적 트리" },
  ...
  { path: "/workspace/message/settings", label: "메시지 설정" },
  { path: "/workspace/community/board", label: "커뮤니티 게시판" },
  { path: "/workspace/community/notice", label: "공지" },
  { path: "/workspace/community/qna", label: "QnA" },
  { path: "/workspace/community/counsel", label: "커뮤니티 상담" },
  { path: "/workspace/community/materials", label: "커뮤니티 자료" },
  { path: "/workspace/community/settings", label: "커뮤니티 설정" },
  { path: "/workspace/community/reports", label: "커뮤니티 신고" },
  { path: "/workspace/community/stats", label: "커뮤니티 통계" },
  ...
  { path: "/workspace/staff/home", label: "직원 홈" },
  { path: "/workspace/staff/attendance", label: "직원 근태" },
  { path: "/workspace/staff/expenses", label: "직원 지출" },
  { path: "/workspace/staff/month-lock", label: "월 마감" },
  { path: "/workspace/staff/payroll-snapshot", label: "급여 스냅샷" },
  { path: "/workspace/staff/reports", label: "직원 리포트" },
  { path: "/workspace/staff/settings", label: "직원 설정" },
  { path: "/workspace/settings/profile", label: "프로필 설정" },
  { path: "/workspace/settings/organization", label: "학원 설정" },
  { path: "/workspace/settings/appearance", label: "외형 설정" },
  { path: "/workspace/settings/landing", label: "홈페이지 설정" },
  { path: "/workspace/settings/consult", label: "상담 수신함" },
  { path: "/workspace/settings/billing", label: "결제 설정" },
  { path: "/workspace/profile/attendance", label: "내 근태" },
  { path: "/workspace/profile/expense", label: "내 지출" },
];
...
const TEACHER_ROUTES: AuditRoute[] = [
  { path: "/workspace/mobile", label: "선생님 대시보드" },
  { path: "/workspace/mobile/students", label: "학생" },
  { path: "/workspace/mobile/classes", label: "강의" },
  { path: "/workspace/mobile/clinic", label: "클리닉" },
  { path: "/workspace/mobile/clinic/remote", label: "클리닉 리모컨" },
  { path: "/workspace/mobile/clinic/reports", label: "클리닉 리포트" },
  { path: "/workspace/mobile/exams", label: "시험" },
  { path: "/workspace/mobile/exams/templates", label: "시험 템플릿" },
  { path: "/workspace/mobile/exams/bundles", label: "시험 묶음" },
  { path: "/workspace/mobile/submissions", label: "제출함" },
  { path: "/workspace/mobile/results", label: "성적" },
  { path: "/workspace/mobile/videos", label: "영상" },
  { path: "/workspace/mobile/comms", label: "커뮤니티" },
  { path: "/workspace/mobile/message-log", label: "발송 이력" },
  { path: "/workspace/mobile/message-templates", label: "메시지 템플릿" },
  { path: "/workspace/mobile/messaging-settings", label: "메시징 설정" },
  { path: "/workspace/mobile/notifications", label: "알림" },
  { path: "/workspace/mobile/storage", label: "내 저장소" },
  { path: "/workspace/mobile/storage/inventory", label: "학생 인벤토리" },
  { path: "/workspace/mobile/counseling", label: "상담" },
  { path: "/workspace/mobile/fees", label: "수납" },
  { path: "/workspace/mobile/fees/invoices", label: "청구서" },
  { path: "/workspace/mobile/staff", label: "직원 관리" },
  { path: "/workspace/mobile/my-records", label: "내 근태/지출" },
  { path: "/workspace/mobile/profile", label: "프로필" },
  { path: "/workspace/mobile/billing", label: "결제" },
  { path: "/workspace/mobile/settings", label: "설정" },
...
test.describe("전 메뉴/버튼 사람형 클릭 감사 - 데스크톱", () => {
  test("관리자 + 개발자 데스크톱 메뉴/버튼", async ({ page }) => {
    ...
    await loginForAudit(page, "admin", "/workspace/dashboard");
...
test.describe("전 메뉴/버튼 사람형 클릭 감사 - 모바일", () => {
  ...
  test("선생님 모바일 메뉴/버튼", async ({ page }) => {
    ...
    await loginForAudit(page, "admin", "/workspace/mobile");
    if (!hasRouteFilter()) {
      await auditDrawerMenu({
        page,
        report,
        role: "teacher",
        startRoute: { path: "/workspace/mobile", label: "선생님 홈" },
